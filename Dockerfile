...
# Add Foundry aliases to .zshrc
RUN echo '\n# Foundry aliases\n\
alias fb="forge build"\n\
alias fc="forge coverage"\n\
alias fcr="forge coverage --report lcov"\n\
alias ft="forge test"\n\
alias ftv="forge test -vv"\n\
alias ftvv="forge test -vvvv"\n\
alias ftmc="forge test --match-contract"\n\
alias ftmt="forge test --match-test"\n\
alias ftmtvv="forge test -vvvv --match-test"' >> $HOME/.zshrc
